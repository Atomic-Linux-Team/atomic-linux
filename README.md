...
| `brain-shell` | Exclusive (External Repo) | Main desktop environment and widgets |
| `atomic-tour` | App (Repo) | Welcome and interactive introduction in GTK4 (not integrated in this version) |
